...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      ...
      <div class="widget-user-image">
      	...
      	<?php else: ?>
        <img class="img-circle elevation-2" src="/task-management-system/assets/uploads/<?php echo $avatar ?>" alt="User Avatar"  style="width: 90px;height:90px;object-fit: cover">
      	<?php endif ?>
      </div>
